...
export const revolutionsRoutes = [
	{
		...
		handler: (request, h) => {
			return revsPerMilePerMillimeter(request.params.input)
		}
	},
	{
		method: 'GET',
		...
		handler: (request, h) => {
			return revsPerMilePerInch(request.params.input)
		}
	},
	{
		method: 'GET',
		...
		handler: (request, h) => {
			return revsPerKilometerPerMillimeter(request.params.input)
		}
	},
	{
		method: 'GET',
		...
		handler: (request, h) => {
			return revsPerKilometerPerInch(request.params.input)
		}
	}
]